  ...
  return (
    <div className="news-detail">
      ...
      <p>
        ...
        available homes and bidding wars for those that are listed. <br />{" "}
        <br />
        According to the National Association of Realtors, existing home sales
        rose by 20% in the last quarter, with the median home price increasing
        by 14%. This is the strongest quarter for home sales since 2006 and the
        highest median price on record. <br /> <br />
        The shortage of available homes is also driving up prices. With fewer
        homes on the market, buyers are willing to pay more to secure a
        property. This has led to a surge in new construction, as builders try
        to keep up with demand. <br /> <br />
        The strong economy is also playing a role in the market boom. With
        unemployment at record lows and consumer confidence high, more people
        are in a position to buy homes. Additionally, low interest rates make it
        more affordable for buyers to finance a home purchase. <br /> <br />
        The market boom is not just limited to a specific region or type of
        home. Sales are up across the country and in all price ranges. This
        includes both single-family homes and condos. <br /> <br />
        ...
        making it difficult for renters to find affordable housing. <br />{" "}
        <br />
